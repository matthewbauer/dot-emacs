...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (esup yaml-mode gitignore-mode coffee-mode go-mode gitconfig-mode gitattributes-mode rust-mode cmake-mode php-mode web-mode nix-mode css-eldoc rainbow-mode crontab-mode markdown-mode less-css-mode json-mode intero js2-mode hungry-delete aggressive-indent fasd editorconfig dumb-jump page-break-lines ag ace-window rainbow-delimiters mwim multiple-cursors buffer-move whitespace-cleanup-mode wrap-region imenu-list magit-gh-pulls gist company-tern company eshell-prompt-extras eshell-z shell-pop esh-help xterm-color magithub helm-projectile projectile lsp-mode helm-ag helm-descbinds helm smartparens smart-tabs-mode mmm-mode apropospriate-theme auto-compile use-package jdee smooth-scrolling smart-mode-line skewer-less savekill readline-complete peep-dired pacmacs ox-gfm origami miniedit jsx-mode js3-mode jasminejs-mode imenu-anywhere flycheck-pos-tip ensime d-mode company-web company-ghci company-ghc company-cabal company-anaconda auctex)))
